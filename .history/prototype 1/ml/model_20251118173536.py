...
try:
    # Prefer explicit relative import when this module is used as part of a package
    from .cost_calculator import AucklandDrivingCostCalculator
except Exception:
    # Fallback to absolute import for standalone execution or environments where
    # the package layout is not available to the importer
    from cost_calculator import AucklandDrivingCostCalculator

class ETAModel:
    def __init__(self):
        self.model = xgb.XGBRegressor()
        self.cost_calculator = AucklandDrivingCostCalculator()  # Create instance
        self.trained = False
